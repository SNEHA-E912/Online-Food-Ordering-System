...
(1, 1, 'North Street Tavern', 'nthavern@mail.com', '3547854700', 'www.northstreettavern.com', '8am', '8pm', 'mon-sat', '1128 North St, White Plains', '6290877b473ce.jpg', '2024-05-27 08:10:35'),
(2, 2, 'Eataly', 'eataly@gmail.com', '0557426406', 'www.eataly.com', '11am', '9pm', 'Mon-Sat', '800 Boylston St, Boston', '606d720b5fc71.jpg', '2024-05-27 08:06:41'),
(3, 3, 'Nan Xiang Xiao Long Bao', 'nanxiangbao45@mail.com', '1458745855', 'www.nanxiangbao45.com', '9am', '8pm', 'mon-sat', 'Queens, New York', '6290860e72d1e.jpg', '2024-05-27 08:04:30'),
(4, 4, 'Highlands Bar & Grill', 'hbg@mail.com', '6545687458', 'www.hbg.com', '7am', '8pm', 'mon-sat', '812 Walter Street', '6290af6f81887.jpg', '2024-05-27 11:01:03');
...
CREATE PROCEDURE PlaceOrder(
    IN user_id INT,
    IN item_title VARCHAR(255),
    IN item_quantity INT,
    IN item_price DECIMAL(10, 2)
)
BEGIN
    INSERT INTO users_orders (u_id, title, quantity, price)
    VALUES (user_id, item_title, item_quantity, item_price);
END //
DELIMITER ;
...
BEGIN
    SELECT * FROM users_orders WHERE u_id = user_id;
END //
...
CREATE TABLE IF NOT EXISTS dashboard_summary (
    ...
    in_process_orders INT DEFAULT 0,
    total_earnings DECIMAL(10,2) DEFAULT 0.00
);
-- Check if the row with id = 1 already exists
INSERT INTO dashboard_summary (id, total_orders, closed_orders, rejected_orders, in_process_orders, total_earnings)
SELECT 1, 0, 0, 0, 0, 0
WHERE NOT EXISTS (SELECT 1 FROM dashboard_summary WHERE id = 1);

-- If the row exists, update it
UPDATE dashboard_summary 
SET total_orders = 0, closed_orders = 0, rejected_orders = 0, in_process_orders = 0, total_earnings = 0 
WHERE id = 1;
